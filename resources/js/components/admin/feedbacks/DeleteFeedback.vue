<template>
    ...
    >
        <v-card>
            <v-card-text>
                <span class="text-h5"
                >Бажаєте видалити повідомлення?</span>
            </v-card-text>
            <v-card-text>
                <v-col
                    cols="12"
            ...
            <v-card-actions>
                ...
                <v-btn
                    ...
                    @click="deleteObj(`/api/admin/delete-feedback/${feedback.id}`)"
                >
                    Видалити
                </v-btn>
            </v-card-actions>
    ...
    >
        <v-card>
            <v-card-text>
                <span class="text-h5"
                >Ви успішно видалили повідомлення</span>
            </v-card-text>
            <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn
                    color="green-darken-1"
                    text
                    @click="closeDeleteObjectConfirmModal(); $emit('getFeedbacks'); removeAttribute()"
                >
                    Закрити
                </v-btn>
            </v-card-actions>
